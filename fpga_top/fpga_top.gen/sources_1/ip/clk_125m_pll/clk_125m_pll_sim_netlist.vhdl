...
-- Date        : Fri Jan 16 23:34:21 2026
-- Host        : Bou6 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/uottahack/uOttaHack_FPGA/fpga_top/fpga_top.gen/sources_1/ip/clk_125m_pll/clk_125m_pll_sim_netlist.vhdl
-- Design      : clk_125m_pll
...
entity clk_125m_pll_clk_wiz is
  port (
...
end clk_125m_pll_clk_wiz;

architecture STRUCTURE of clk_125m_pll_clk_wiz is
...
entity clk_125m_pll is
  ...
  attribute NotValidForBitStream of clk_125m_pll : entity is true;
end clk_125m_pll;

architecture STRUCTURE of clk_125m_pll is
begin
inst: entity work.clk_125m_pll_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
