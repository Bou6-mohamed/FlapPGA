...
HD_PWD='C:/uottahack/uOttaHack_FPGA/fpga_top/fpga_top.runs/clk_125m_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_125m_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_125m_pll.tcl
