...
HD_PWD='C:/uottahack/uOttaHack_FPGA/fpga_top/fpga_top.runs/xcv_hdmi_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xcv_hdmi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xcv_hdmi.tcl
